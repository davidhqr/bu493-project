...
Data=read.csv("C:/Users/ASUS/Desktop/1d_senate_returns.csv",header=T)
attach(Data)
Model1 <- lm(return_abnormal_1d ~ as.factor(owner)+as.factor(type)+as.factor(Senator)+Age+In_Office+as.factor(Party)
             +Data$Budget
